...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/moviehub4u_premium/834')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 Official Channel 💥', url=f"https://t.me/moviehub4u_update"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/moviehub4u_update')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
            InlineKeyboardButton('😎 Support 😎', url='https://t.me/moviehub4u_support'),
            InlineKeyboardButton('🌟 Premium 🌟', url='https://t.me/vip_moviehub_4u')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
